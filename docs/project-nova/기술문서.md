...
* [EquipmentManager.cs](../../src/project-nova/Equipment/EquipmentManager.cs)
...
sequenceDiagram
    ...
    participant T as 타이틀 화면
    participant TR as 전환 연출
    participant L as 로그인 팝업

    P->>T: 시작 버튼 클릭
    T->>TR: BGM 페이드아웃 / SFX 재생
    TR->>TR: 암전 전환
    TR->>TR: 문 살짝 열림 / 닫힘
    TR->>TR: 웜홀 등장
    TR->>TR: 문 오픈
...
* [타이틀 전환 연출 GIF](../../docs/project-nova/assets/gifs/title-transition.gif)
* [장비 제작·강화 UI GIF](../../docs/project-nova/assets/gifs/equipment-ui.gif)
* [승무원 해금·업그레이드 UI GIF](../../docs/project-nova/assets/gifs/title-transition.gif)
* [탐사 요약 UI GIF](../../docs/project-nova/assets/gifs/explore-summary.gif)
* [전체 시연 영상](https://youtu.be/1-ljXu4yQG0)
